...
class Image_Transform {
    ...
    function &factory($driver = '') {
        if ($driver == '') {
            ...
            if (!$driver) {
                return PEAR::raiseError(
                                ...
                                . ' You must specify driver in factory() call.', IMAGE_TRANSFORM_ERROR_ARGUMENT
                );
            }
        } else {
        ...
        if (!class_exists($classname)) {
            ...
            if (!class_exists($classname)) {
                return PEAR::raiseError(
                                'Image library ' . $driver . ' not supported... aborting.', IMAGE_TRANSFORM_ERROR_UNSUPPORTED
                );
            }
        }
        $obj = new $classname();
...
//function getHandle()
    ...
    function intersects($width, $height, $x, $y) {
        ...
        return (bool) ($left < $this->new_x && $right >= 0 && $top < $this->new_y && $bottom >= 0);
    }
