...
$(document).ready(function(){	//http://www.uploadify.com/documentation/
	...
	$("#mcs_container").mCustomScrollbar("vertical",100,"easeOutCirc",1.05,"fixed","yes","yes",5);
	...
	$('#file_upload').uploadify({
		...
		'buttonText'  : 'Vl',
		'buttonImg' : '/images/admin/upload_file_text.png',
		...
		'onAllComplete' : function(event,data) {
			...
			$("#success-message").html("Soubory uloženy");
	...
	$(".imageName, .imageDescription, .imageUrl, .imagePriority, .imageVisible").each(
		function () {
			$(this).change(
				function () {
