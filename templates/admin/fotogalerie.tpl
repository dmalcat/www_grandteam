<h1 class="clanek_title">{if $dbGallery}EDITACE FOTOGALERIE - {$dbGallery->name}{else}NOVÁ FOTOGALERIE{/if} </h1>
<form method="post" id="nova_fotogalerie" enctype="multipart/form-data">
    ...
    <div class="submit_box">
		<input type="hidden" name="id_gallery_type" value="{dbGallery::TYPE_FOTO}"/>
		<input type="hidden" name="id_gallery_template" value="{dbGallery::TYPE_FOTO}"/>
		{if $dbGallery}
