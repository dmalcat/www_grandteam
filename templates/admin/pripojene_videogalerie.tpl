<div class="fotogalerie_box">
	<h2>PŘIPOJENÉ VIDEOGALERIE {if $dbCC}({$dbCC->getMappedGalleries(dbGallery::TYPE_VIDEO)|@count}){/if}</h2>
	{if $dbCC}
		{foreach from=$dbCC->getMappedGalleries(dbGallery::TYPE_VIDEO) item=pGallery name=fotogalerie}
		...
		<form action="" method="post">
			...
			<div class="galerie_select">
				<select name="idGallery">
					...
					{foreach from=dbGallery::getAll(dbGallery::TYPE_VIDEO) item=pGallery}
