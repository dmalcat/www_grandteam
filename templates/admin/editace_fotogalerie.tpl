<h1 class="clanek_title">OBSAH FOTOGALERIE / EDITACE FOTOGALERIE -  [ odkaz: {$dbGallery->getUrl()} ]</h1>
                    ...
                    <div class="content">
                        {foreach from=$dbGallery->getImages(false) item=dbGalleryImage name=fotogalerie}
                            <div class="foto_box" style="background-color:{cycle values="#EBEBEB,#fff"}" id="galleryImage_{$dbGalleryImage->id}">
                                ...
                                <div class="foto_obr">
                                    <a href="{$dbGalleryImage->dImage}" rel="shadowbox[]">
                                        <img src="{$dbGalleryImage->tImage}" alt=" " border="0" />
                                    </a>
                                </div>
                                <div class="foto_text">
                                ...
                                <div class="foto_data">
                                    ...
                                    <div class="foto_smazat"><a href="javascript: void(0)" title="Smazat fotografii" id="imageDelete_{$dbGalleryImage->id}" class="imageDelete"  rel="{$dbGalleryImage->id}"></a></div>


                                    <form action="" method="post" enctype="multipart/form-data" id="galleryImageForm_{$dbGalleryImage->id}">
                                        <div class="foto_vymena">
                                            <input type="file" name="image" class="galleryImageFileInput" rel="{$dbGalleryImage->id}"/>
                                            <input type="hidden" name="image[name]" value="{$dbGalleryImage->name}"/>
                                            <input type="hidden" name="idImage" value="{$dbGalleryImage->id}"/>
                                        </div>
                                        <div class="odkaz_bg">
                                            <input type="text" name="url" class="imageUrl" id="imageUrl_{$dbGalleryImage->id}" placeholder="odkaz fotografie ..."   rel="{$dbGalleryImage->id}" value="{$dbGalleryImage->url}"/>
                                        </div>
                                        <div class="autor_bg">
                                            <input type="text" name="author" class="imageAuthor" id="imageAuthor_{$dbGalleryImage->id}" placeholder="autor fotografie ..."   rel="{$dbGalleryImage->id}" value="{$dbGalleryImage->author}"/>
                                        </div>
                                        <!--
