...
<div class="row">
	<div class="col-md-12">
		<div class="well margin-top-15 padding-left-10 padding-right-10">
			<h2>{'Mám zajem o více informací'|translate}</h2>
			...
			<form class="form-horizontal" action="" method="post"  id="form_kontaktni_formular">
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-md-6">                     
							<textarea class="form-control" id="vzkaz" name="kontakt[vzkaz]" rows="2" style="height: 100px;">Mám zájem o více informací k produktu {$dbCC->name}</textarea>
						</div>
					</div>
					<div class="form-group">
