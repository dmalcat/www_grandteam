					...
					<div class="vypis_content_box" style="width:815px;">
						<div class="vypis_content_box_text" style="width:785px; font-size:16px;"> 
                          <div style="float:left; width: 208px; height: 115px; margin-right:10px; ">
							<img src="{$dbGallery->galleryImage}" style="max-width: 208px; max-height: 115px; margin-right:10px; float:left;" /></div>
							<a href="{$dbGallery->getUrl()}" style="text-decoration:none;" ><h2 style=" font-size:19px;">{$dbGallery->name}</h2></a> 
